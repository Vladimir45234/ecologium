    ...
    <section class="glavnaya2" id="glavnaya2">
        <div class="container">
            <div class="left-block">
                <button class="ecologia ec1" onclick="window.open('/lessons/1.php')"><a>Введение в экологию</a></button>
                <button class="ecologia ec2" onclick="window.open('/lessons/2.php')"><a>Человек и экология</a></button>
                <button class="ecologia ec3" onclick="window.open('/lessons/3.php')"><a>Животные и экология</a></button>
                <button class="ecologia ec4" onclick="window.open('/lessons/4.php')"><a >Природа и экология</a></button>
                <button class="ecologia ec5" onclick="window.open('/lessons/5.php')"><a >Загрязнения в экологии</a></button>
                <button class="ecologia ec6" onclick="window.open('/lessons/6.php')"><a>Добыча полезных ископаемых</a></button>
                <button class="ecologia ec7" onclick="window.open('/lessons/7.php')"><a>Решения, которые помогут</a></button>
                <button class="ecologia ec8" onclick="window.open('/lessons/8.php')"><a>Как развивать?</a></button>
            </div>
        </div>
    </section>
<?php } else{ ?>
